// delayed.js — homepage content injected after AEM loads

import { RINX, GAMES } from './scripts.js';
...
function buildHomepage() {
  ...
  function resultRow(g) {
    const ini = g.opp.split(' ').slice(0, 2).map(function(w) { return w[0]; }).join('').toUpperCase();
