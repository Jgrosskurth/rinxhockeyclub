...
export default function decorate(block) {
  ...
  block.innerHTML = `
    <svg class="hero-rink" viewBox="0 0 1200 560" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      ...
      <rect width="1200" height="560" fill="url(#rg1)"/>
    ...
    <div class="hero-content">
      ...
      <div class="hero-strip">
        <div class="hs-block"><div class="hs-num red">${record.w}&ndash;${record.l}&ndash;${record.t}</div><div class="hs-lbl">W&ndash;L&ndash;T</div></div>
        <div class="hs-div"></div>
        <div class="hs-block"><div class="hs-num">${record.gf}&ndash;${record.ga}</div><div class="hs-lbl">GF&ndash;GA</div></div>
        <div class="hs-div"></div>
        <div class="hs-block"><div class="hs-num red">${record.rating}</div><div class="hs-lbl">MHR Rating</div></div>
        <div class="hs-div"></div>
        <div class="hs-block"><div class="hs-num">${gp}</div><div class="hs-lbl">Games Played</div></div>
      </div>
