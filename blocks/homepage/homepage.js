...
export default function decorate(block) {
  ...
  const nc = (n) => `<div class="slide-card"><div class="slide-card-body"><div class="news-tag">${n.tag}</div><h3>${n.title}</h3><p>${n.body}</p><div class="news-date">${n.date}</div></div></div>`;
      ...
      <div class="bio-grid">
        ...
        <div class="bio-card"><h3>Coaching Staff</h3>
          <div class="coach-card" style="margin-bottom:12px">
            <img src="https://raw.githubusercontent.com/Jgrosskurth/rinxhockeyclub/main/icons/dan.jpg" alt="Dan" class="coach-av coach-photo" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
          ...
          <div class="coach-card">
            <img src="https://raw.githubusercontent.com/Jgrosskurth/rinxhockeyclub/main/icons/cap.png" alt="Joe" class="coach-av coach-photo" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
